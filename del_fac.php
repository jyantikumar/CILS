            ...
            <section class="mx-5">
              <div class="row my-5">
                <div class="col-sm-12">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="card-title fw-semibold text-center mb-5">Delete</h3>
                      <div class="row mx-5">
                      ...
                      <button type="submit" class="btn float-end" style="background-color: #3c6e7a; color: white;" name="delete-faculty">Delete</button>
                      </div>
                    </form>
                  </div>
                </div>
