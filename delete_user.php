  ...
  if (isset($_POST["delete-user"])){
      ...
      if ($result && $row = mysqli_fetch_assoc($result)){
          ...
          if ($password == $row['userPassword']){
              ...
              $schedSQL = mysqli_query($conn, "SELECT * FROM users WHERE userID='$userID'");
              ...
              <section class="mx-5">
                <div class="row my-5">
                  <div class="col-sm-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="card-title fw-semibold text-center mb-5">Delete User</h3>
                        <div class="row mx-5">
                        ...
                        <button type="submit" class="btn float-end" style="background-color: #3c6e7a; color: white;" name="delete-user">Delete</button>
                        </div>
                      </form>
                    </div>
                  </div>
