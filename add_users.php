...
if (isset($_POST['add_users'])) {
        ...
        $user_email =strtoupper(trim($_POST['user_email']));
          $user_pass=trim($_POST['user_pass']);

$userSQL="Select * from users where userEmail='$user_email'";
$userResult=$conn->query($userSQL);
if (mysqli_num_rows($userResult) > 0) {
echo "<script>alert('User already exists')</script>";
}else{

       $sql = "INSERT INTO users (first_name, last_name, userEmail, userPassword) 
                  ...
                  <div class="faculty-form">
                    <form method="POST">
                        <div class="row">
                            ...
                            <label for="facultyName" class="form-label"> First Name</label>
                        <input type="text" class="form-control" id="facultyName" name="first_name" required>
                        <div class="invalid-feedback">Please provide a name.</div>
                      </div> 
                      <div class="col-6   pb-4">
                            <label for="facultyName" class="form-label"> Last Name</label>
                        <input type="text" class="form-control" id="facultyName" name="last_name" required>
                        <div class="invalid-feedback">Please provide a name.</div>
                      ...
                      <div class="row">
                        ...
                        <input type="email" class="form-control" id="facultyEmail" name="user_email" required>
                        <div class="invalid-feedback">Please provide a valid email.</div>
                      </div>
                            <div class="col-6  pb-4">
                                <label for="user_pass" class="form-label">Enter password</label>
                                <input type="password" class="form-control" id="faculty_pass" name="user_pass" required>
                            </div>

</div>
            <button type="submit" class="btn" style="background-color: #3c6e7a; color: white;" name="add_users">Add User</button>
                    </form>
                  </div>
      </div>
                  <center>
