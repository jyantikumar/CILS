    ...
    if($password==$row['userPassword']){
        ...
        $facultySQL=mysqli_query($conn, "SELECT * from faculty_tbl where faculty_id='$faculty_id'");
            ...
            if(mysqli_num_rows($facultySQL)>0){
                $sql="update faculty_tbl set faculty_status='ACTIVE' where faculty_id='$faculty_id'";
            ...
            <section class="mx-5">
              <div class="row my-5">
                <div class="col-sm-12">
                  <div class="card">
                    <div class="card-body">
                      <h3 class="card-title fw-semibold text-center mb-5">Retrieve Faculty</h3>
                      <div class="row mx-5">
                        ...
                        <div class="col-12 pb-4">
                          <center><label for="course-description" class="form-label">Enter Password to Retrieve</label>
                      ...
                      <button type="submit" class="btn float-end" style="background-color: #3c6e7a; color: white;" name="delete-faculty">Save edit</button>
                      </div>
                    </form>
                  </div>
                </div>
