...
$sql = "SELECT * FROM faculty_tbl where faculty_status='ARCHIVED'"; 
                  ...
                  <tbody>
                    <?php if ($result->num_rows > 0): ?>
                      <?php while ($row = $result->fetch_assoc()): ?>
                        ...
                        <td> 
                        <?php echo htmlspecialchars($row['faculty_status']);  ?> 
                        </td>
                        <TD>
                                                         <div class="action-container">
  <button class="ellipsis-btn" aria-label="Actions">&#8942;</button>
  <div class="action-buttons">
                              <a href="retrieve_faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>" class="btn btn-warning">Retrieve</a>
                              <a href="del_fac.php?faculty_id=<?php echo $row['faculty_id']; ?>" class="btn btn-danger">Delete</a>
                    ...
                    <?php else: ?>
                      <tr>
                        <td colspan="5" class="text-center">No archived faculty.</td>
                      </tr>
                    <?php endif; ?>
                  </tbody>
           ...
           <!-- <div class="card-footer text-end">
              <center>
                <a href="faculty-management-edit.php">
              <button class="btn" style="background-color: #3c6e7a; color: white;">Add Faculty</button>
              </a>
            </center>
            </div> !-->
          </div>
