...
$sql = "SELECT * FROM faculty_tbl WHERE faculty_status IN ('ACTIVE', 'INACTIVE')";
...
<i class="lni lni-book"></i>        <span>Curriculum</span>
  ...
  <div class="action-buttons">
    <a href="edit-faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>" class="btn btn-warning">Edit</a>
                             <a href="delete_faculty.php?faculty_id=<?php echo $row['faculty_id']; ?>" class="btn btn-danger">Archive</a>
  </div>
</div>
