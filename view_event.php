...
// Query to fetch data
$sql = "SELECT * FROM create_event order by eStart_date desc"; 
        ...
        <main class="content px-3 py-4">
          ...
          <section id="dashboard" class="mx-4 pb-0" style="font-family: 'Montserrat';">
            ...
            <div class="container" style="max-width: 1920px;">
              <h1 class="text-center my-5">View Events</h1>
              <div class="input-group" style="max-width: 400px;">

                 <form action="search_event.php" method="GET" style="max-width: 400px; margin-bottom: 30px;">
...
echo '</nav>';
                  ...
                  <table class="table">
                    <thead class="table-info">
                      ...
                      <th scope="col" style="background-color: #3c6e7a; color: white;">Date</th>
                        ...
                        <th scope="col" style="background-color: #3c6e7a; color: white;">Action</th>
                      </tr>
                    </thead>
                    <tbody>
  ...
  <div class="action-buttons">
                                    ...
                                    <a href="del_event.php?event_id=<?php echo $row['event_id']; ?>" class="btn btn-danger">Delete</a>
  </div>
</div>
