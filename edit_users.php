...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["userID"])) {
    ...
    if (strlen($user_pass) < 8) {
        ...
        $sql = "UPDATE users SET first_name='$first_name', last_name='$last_name', userPassword='$userPassword' WHERE UserID='$UserID'";
              ...
              <main class="content px-3 py-4">
                ...
                <div class="faculty-management-wrapper">
                  ...
                  <div class="faculty-form">
                    <form method="POST">
    <input type="hidden" name="userID" id="userID" value="<?php echo isset($_GET['userID']) ? $_GET['userID'] : ''; ?>">
                      ...
                      <div class="row">
                        ...
                        <input type="email" class="form-control" id="facultyEmail" name="user_email" value="<?php echo $row['userEmail'];?>"required>
                        <div class="invalid-feedback">Please provide a valid email.</div>
                      </div>
                            <div class="col-6  pb-4">
                                <label for="user_pass" class="form-label">Enter password</label>
                                <input type="password" class="form-control" id="faculty_pass" name="user_pass" value="<?php echo $row['userPassword'];?>" required>
                            </div>

</div>
            <button type="submit" class="btn" style="background-color: #3c6e7a; color: white;" name="add_users">Save Changes</button>
                    </form>
                  </div>
      </div>
                  <center>
